...
cl = YYK.LINE()
cl.login(token="EnR3VHxgGLTdlTFSyP28.wj+hgFH9yy5UGkxxf3dYoa.ZWFivXMScYaoGjc+XqzBiJY1wBGxOM1cSFcLQyEBeqI=")
cl.loginResult()

ki = YYK.LINE()
ki.login(token="EnfVPlz1VR0OquuejNCd.ZNevD4Is9IewdiWkTIWLJq.n6nX9BMkbS7pUDHdCayb1lSFzSn4Q9bWXugUXDGs3D8=")
ki.loginResult()

ki2 = YYK.LINE()
ki2.login(token="EnRdgr7bRwZeHfN6ifo6.eGZYPxbl4nhRLgbq5VFDjG.JP50nCZWiiiZYBj5KrxGfDo7hBWhN+WmNLiFI9+L+rk=")
ki2.loginResult()

ki3 = YYK.LINE()
ki3.login(token="EnmEW3eHNAUHrymJx708.nTtbRZ1edAbRtDpor5jfoa.dytvtF50SF6C5YcyOvzy4P3NZV2EynjXfvAgAKpn510=")
ki3.loginResult()

ki4 = YYK.LINE()
ki4.login(token="En0UbvsUjNiXVxDZNDp9.KmGKwMk/ez9em2F+UvWGEq.I5gxbm515I3V6SKIN3/8Uqi4O2VBkN5qWGDCi1Buyig=")
ki4.loginResult()

ki5 = YYK.LINE()
ki5.login(token="EnHFNagRDd3FhDeSqPk6.mVZpxx3RyqobLmGNJ7pzXG.jZbvhMFd5Os+50wUSxI52UJYuprJ4HdCBV3WdY3JS+8=")
ki5.loginResult()

ki6 = YYK.LINE()
ki6.login(token="EnoZL2eWfapolDEm7eT8.U/Oj62MIhwu/CNwNLoVeka.5Gl6MPYKdpDTgUn066sSydcJ+/Br3n0osvRqPzpY+zU=")
ki6.loginResult()

ki7 = YYK.LINE()
ki7.login(token="EnQNZYdHz0nVWYD8UPe4.G2K18sps6sJSwH3yCOBTPa.0KEIbwsUnAai6aG8oa2yFacyPfPdUNg3buCEVNv00zA=")
ki7.loginResult()

ki8 = YYK.LINE()
ki8.login(token="Enm7qUC8AwsCeG5wIHg1.9+oELPQwBi6dcX64D2Ok4q.eGPF6cuOb3J8ncELl4roAJDRLOf7NcAw//6tGV8Ygl8=")
ki8.loginResult()

ki9 = YYK.LINE()
ki9.login(token="EnWvoVwPAGT3pK972fc7.rVQvDQx7C9bHav+GbryUnW.Ce+BTYpyUe1PHIwLv10WX8Xw3zYTj+T8XNZrALW/PKk=")
ki9.loginResult()

ki10 = YYK.LINE()
ki10.login(token="Enu7eS1UpcqlMrmDcvJ7.a8JA9Nwv9o9NwUHeLI2g1W.DicsqqmPGR5u7uS1r1K8jLexuiwtSuKWvvk6DV8yOe0=")
ki10.loginResult()
...
admin = ["u589fc719f87d618e6e80a5d71770f238","u74927467b80b399ca6e5c9082dd910b9"]
admsa = ["u589fc719f87d618e6e80a5d71770f238","u74927467b80b399ca6e5c9082dd910b9"]
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == ["u589fc719f87d618e6e80a5d71770f238"]:
                    if "join:" in msg.text:
